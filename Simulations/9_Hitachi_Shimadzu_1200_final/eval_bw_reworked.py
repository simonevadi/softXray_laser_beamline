...
from parameter_bw import rml_file_name_Laser_BL as rml_file_name
...
flux_simulation_folder = 'RAYPy_Simulation_'+rml_file_name+'bw_FLUX'
rp_simulation_folder = 'RAYPy_Simulation_'+rml_file_name+'bw_RP'
