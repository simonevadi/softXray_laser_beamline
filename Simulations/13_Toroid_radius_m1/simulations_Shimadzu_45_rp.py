...
from parameter import nrays, rounds, ncpu, m1_radius
from parameter import energy, SlitSize
from parameter import rml_file_name_Laser_Shimadzu_45 as rml_file_name
...
sim.params = [              
            ...
            {beamline.M1.shortRadius:m1_radius},
        ]
