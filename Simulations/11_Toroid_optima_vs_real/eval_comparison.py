...
from parameter import rml_file_name_Laser_Shimadzu_opt, rml_file_name_Laser_Shimadzu_real
...
rml_comparison_list = {}
rml_comparison_list[rml_file_name_Laser_Shimadzu_real]      = 0
rml_comparison_list[rml_file_name_Laser_Shimadzu_opt]       = 0
...
fig.suptitle(f"MetrokX-BL Shimadzu 1200 l grating optimal vs. real Radius comparison")
