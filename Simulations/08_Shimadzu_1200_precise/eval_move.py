...
from parameter_move import energy
from parameter_move import SlitSize
from parameter_move import rml_file_name_Laser_BL_Shimadzu_move as rml_file_name
from parameter_move import colors
...
plt.tight_layout()
plt.savefig('plot/FluxRpFocus'+rml_file_name+'move detector'+'.pdf')
