...
from parameter_normal import energy
from parameter_normal import SlitSize
from parameter_normal import rml_file_name_Laser_BL_Kapillare as rml_file_name
from parameter_normal import colors
#from parameter import lin_polarization



# file/folder/ml index definition
flux_simulation_folder = 'RAYPy_Simulation_'+rml_file_name+'normal_FLUX'
rp_simulation_folder = 'RAYPy_Simulation_'+rml_file_name+'normal_RP'
...
plt.tight_layout()
plt.savefig('plot/FluxRpFocus'+rml_file_name+'_normal.pdf')
