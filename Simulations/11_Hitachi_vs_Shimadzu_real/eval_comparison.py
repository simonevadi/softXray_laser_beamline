...
from parameter import rml_file_name_Laser_Shimadzu, rml_file_name_Laser_Hitachi
...
rml_comparison_list = {}
rml_comparison_list[rml_file_name_Laser_Shimadzu]      = 0
rml_comparison_list[rml_file_name_Laser_Hitachi]       = 0
...
plt.tight_layout()
plt.savefig('plot/MetrokX-BL Shimadzu vs Hitach 1200 l Grating.pdf')
